(function () {
      ...
      d(i, function (i) {
        function a() {
          function n() {
            ...
            return (
              v.bindTexture(r, o),
              e(r, v.TEXTURE_WRAP_S, v.CLAMP_TO_EDGE),
              e(r, v.TEXTURE_WRAP_T, v.CLAMP_TO_EDGE),
              e(r, v.TEXTURE_MIN_FILTER, v.LINEAR),
              e(r, v.TEXTURE_MAG_FILTER, v.LINEAR),
              v.texImage2D(r, 0, v.RGBA, v.RGBA, v.UNSIGNED_BYTE, p),
              !0
            );
          }
          function a(t, e) {
            ...
            if (s) {
              ...
              if (0 != e || 0 != y) {
                (y = e),
                  ...
                  v.uniform1f(
                    g,
                    "true" == i.getAttribute("data-stop-on-scroll") ? e : 0
                  ),
                  v.uniform2f(d, h.width * A, h.height * A),
                  v.uniform1f(f, S),
                  v.bindBuffer(v.ARRAY_BUFFER, k);
                var n;
                v.vertexAttribPointer(n, 2, v.FLOAT, !1, 0, 0),
                  ...
                  v.viewport(0, 0, h.width * A, h.height * A);
              }
            }
          }
          var s,
        ...
        function c() {
          function t(t, e, n) {
            ...
            f(t.length, function (o) {
              ...
              (r += "." == u ? 0 : "j" == u ? -1 : 1),
                0 == r ||
                  a ||
                  ((a = !0), i.moveTo((d.x + (o - 1) * l * e) * A, d.y * A)),
                i.lineTo((d.x + o * l * e) * A, (d.y + r * l * n) * A);
            }),
              i.closePath(),
              i.fill();
          }
          ...
          e(2, w.french_gray, w.antiflash_white),
            e(1, w.outer_space, w.french_gray),
            e(0, w.eerie_black, w.outer_space);
          ...
          return (
            ...
            i.drawImage(p, 0, 0),
            k.clearRect(0, 0, h.width * A, h.height * A),
            k.restore(),
            k.drawImage(r, 0, 0),
            i.clearRect(0, 0, h.width * A, h.height * A),
            i.restore(),
            s(w.seasalt, i),
            i.beginPath(),
            (S = 2.5 * l * A),
            i.arc(d.x * A, d.y * A, S, Math.PI, 2 * Math.PI),
            i.fill(),
            i.drawImage(p, 0, 0),
            r
          );
        ...
        var h = u(i);
        g(h, A, i);
        var d = { x: h.width / 2, y: h.height / 2 };
        null == l && (l = c());
        var p = l;
        a(), (i.style.opacity = 0.9999);
      }),
      {
        stop: function () {
          r = !0;
  ...
  function k() {
    ...
    return (
      (function v() {
        var n = t();
        if (b.innerHeight > n) {
          l.clearRect(0, 0, f.width * A, f.height * A), s(w.seasalt, l);
          var i = [];
          d(p, function (t) {
            (t.s += t.speed * (t.growing ? 1 : -1)),
              t.s > 1 && (t.growing = !1),
              0 > t.s ||
                (i.push(t), r(t.x * A, t.y * A, 1, h(t.s) * t.maxSize * A, l));
          }),
            c(1) < 5e-7 * b.innerWidth * b.innerHeight && i.push(e()),
            (p = i);
          var o = 0.75 * y - n;
          d(k, function (t) {
            l.globalAlpha = t.a;
  ...
  var w = {
    seasalt: "#f8f9faff",
    slate_gray: "#6c757dff",
    french_gray: "#ced4daff",
    outer_space: "#495057ff",
    eerie_black: "#212529ff",
    antiflash_white: "#e9ecefff",
    },
    E = 120,
    y = 0,
    b = window,
  ...
  (function () {
    ...
    (function () {
      var t = i(".Email");
      l("href", "mailto:lucasbbebber@gmail.com", t),
        (t.innerHTML =
          "<strong>lucasbbebber</strong>@<strong>gmail</strong>.com");
    })();
  var H = !1;
      ...
      d(t, function (t) {
        t.addEventListener("click", function (n) {
          ...
          s + b.innerHeight > c && (s = c - b.innerHeight),
            b.scrollTo(0, s),
            (r.style.transform = "translate3d(0," + s + "px,0)");
          var h = 300 + 0.3 * s,
            f = 0,
            d = s,
            g = 0,
          ...
          _(function () {
            ...
            (function a() {
              ...
              var u = d + w(f) * p,
                l = Math.min(0, u - k + 5);
              (i =
                1 > f ? [l].concat(i.slice(0, 2)) : i.slice(0, i.length - 1)),
                (k = u),
                (n += l),
                (r.style.transform = "translate3d(0," + u + "px,0)"),
                (1 > f || i.length > 0) && _(a);
            })();
          });
        });
